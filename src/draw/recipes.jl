...
#   blob_specs = S.Blobs(blobs; color=:red, scale_factor=3.0)
...
function Makie.convert_arguments(::Type{<:AbstractPlot}, img::AbstractMatrix{<:Colorant}, blobs::Vector{<:AbstractBlob};
    ...
    lscene = Spec.Imshow(img; interpolate=interpolate)
    blob_specs = Spec.Blobs(blobs; color=color, scale_factor=scale_factor,
...
function Makie.convert_arguments(::Type{<:AbstractPlot}, img::AbstractMatrix{<:Colorant},
    ...
    gt_specs = Spec.Blobs(ground_truth; color=ground_truth_color, scale_factor=scale_factor,
    ...
    det_specs = Spec.Blobs(detections; color=detection_color, scale_factor=scale_factor,
...
function Makie.convert_arguments(::Type{<:AbstractPlot}, blobs::Vector{<:AbstractBlob};
    ...
    return Spec.Blobs(blobs; color=color, scale_factor=scale_factor,
...
function Makie.convert_arguments(::Type{<:AbstractPlot}, detections::Vector{IsoBlobDetection};
    ...
    return Spec.Blobs(detections; color=color, scale_factor=scale_factor,
                    marker=marker, markersize=markersize,
                    linewidth=linewidth, linestyle=linestyle)
end
